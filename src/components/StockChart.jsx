...
export const StockChart = ({chartData, symbol}) => {
	...
	//subtracts the last entry of the dataset to the first entry
	const color = determineTimeFormat()[determineTimeFormat().length.y - 1] - determineTimeFormat()[0].y > 0 ? "#26C281" : "#ED3419"
